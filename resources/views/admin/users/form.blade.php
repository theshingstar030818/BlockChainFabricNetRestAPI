...
<div class="form-group{{ $errors->has('is_admin') ? ' has-error' : ''}}">
    ...
    {!! Form::checkbox('is_admin', 1, null, ['class' => 'form-control width-10-percent']) !!}
    {!! $errors->first('is_admin', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group{{ $errors->has('is_enabled') ? ' has-error' : ''}}">
    {!! Form::label('is_enabled', 'Is Enabled: ', ['class' => 'control-label']) !!}
    {!! Form::checkbox('is_enabled', 1, null, ['class' => 'form-control width-10-percent']) !!}
